...
public class PickUpSpawner : MonoBehaviour
{
	...
	public float dropRangeLeft=-10;                 // Smallest value of x in world coordinates the delivery can happen at.
	public float dropRangeRight=4;                // Largest value of x in world coordinates the delivery can happen at.
	...
	public IEnumerator DeliverPickup()
	{
		...
		Vector3 dropPos = new Vector3(dropPosX, 8f, 0f);
